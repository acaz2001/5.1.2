...
import { urlFor } from '../sanity/lib/image'; // ✅ tvoj image helper
...
function ProductClient({ product}) {
  ...
  console.log("URL:", urlFor(selectedVariant.image).url())
  console.log("Asset ref:", selectedVariant.image?.asset?._ref)
console.log("📸 Variant image:", selectedVariant.image.asset)
